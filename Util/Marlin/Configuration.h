...
#define STRING_CONFIG_H_AUTHOR "Darth Lab" //Who made the changes.
...
//    #define  DEFAULT_Kd 75.04
 ...
 // Segunda prueba LAB FRA
    #define  DEFAULT_Kp 27.02
    #define  DEFAULT_Ki 2.66
    #define  DEFAULT_Kd 68.63
...
/* Cambiamos el valor de Z de 2560 a 2635 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2700,777}  // default steps per unit for ultimaker
/* Cambio el valor de MAX FEEDRATE Z de 3.3 a 1.5 */
#define DEFAULT_MAX_FEEDRATE          {330, 330, 1.5, 45}    // (mm/sec)
